...
from minimind_old.model.model_minimind import MiniMindConfig, MiniMindForCausalLM
from minimind_old.model.model_lora import *
from minimind_old.trainer.trainer_utils import setup_seed
...
def init_model(args):
    ...
    if 'model' in args.load_from:
        ...
        ckp = f'/home/boran.lbr/LLM_model/MiniMind2/{args.save_dir}/{args.weight}_{args.hidden_size}{moe_suffix}.pth'
...
def model_init():
    model_path = "/home/boran.lbr/gitspace/github/minimind/save/hf/sft_v0"  # 替换成你的模型路径
